...
function ready() {
  ...
  for (var i = 0; i < removeCartButtons.length; i++) {
    ...
    input.addEventListener("change", quantityChaneged);
  }
  // dodavanje u korpu
  ...
  document
    ...
    .addEventListener("click", byButtonClicked);
}
//buy btn
...
function addCartClicked(event) {
  ...
  var title = shopProducts.getElementsByClassName("produce-title")[0].innerText;
